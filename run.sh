...
#    On the test set, run this for final submission
#    python3 adapt_detnet_dual.py -trs ah -tes ah --set test --root_idx 0 --pic 1024 --resume -eid 34 --epochs 10 --start_epoch 1 --gpus ${gpu} --checkpoint in_dataset_adapt --setup ${setup} --pair ${pair}
  done
done
